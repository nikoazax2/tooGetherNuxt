  ...
  <div id="app" data-app>
    ...
    <div class="conteneurcard">
      ...
      >
          ...
          <v-list-item class="grow">
            <v-list-item-avatar color="grey darken-3">
              <v-img
                class="elevation-6"
                alt=""
                :src="activity.users[0].avatar"
              ></v-img>
            </v-list-item-avatar>

            <v-list-item-content>
              <v-list-item-title>{{
                activity.users[0].surname
              }}</v-list-item-title>
            </v-list-item-content>
        ...
        <v-divider class="dividerdetail"></v-divider>
        <v-card-action>
          <div v-if="activity.users.length > 1">
            <div v-for="users in activity.users" :key="users.id">
              <div v-if="users != activity.users[0]">
                <v-list-item-avatar color="grey darken-3">
                  <v-img class="elevation-6" alt="" :src="users.avatar"></v-img>
                </v-list-item-avatar>
                {{ users.surname }}
              </div>
            </div>
        ...
        <v-card-action class="conteneurbtninscrit">
          <v-btn
